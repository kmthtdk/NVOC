  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl z-50 overflow-hidden animate-fadeIn"
        >
