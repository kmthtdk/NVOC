...
INSERT INTO tickets
  ...
  (2, 'REQ-2026-0002',
   ...
   'server_request', 'folder', NULL, 'urgent', 'waiting',
  ...
  (4, 'REQ-2026-0004',
   ...
   'hardware_request', 'laptop', NULL, 'high', 'waiting',
...
INSERT INTO ticket_history (ticket_id, status, status_label, updated_by, notes, created_at) VALUES
  ...
  (1, 'waiting',    'Under Investigation',    'Marcus Vance',  'Triage complete. Configuring policy rules on Fortigate firewall and provisioning database credentials.', '2026-06-16 18:15:00'),
  ...
  (2, 'waiting',    'System Diagnostics',     'Lucas Croft',   'Identified the directory mount structure. Initialising folder snapshot restore process.', '2026-06-17 17:45:00'),
  ...
  (4, 'waiting',    'Assigned & Accepted',    'Nicholas Croft','Identified hardware thermal throttling error. Requested direct handoff for physical dusting and re-pasting.', '2026-06-15 21:30:00'),
  (4, 'waiting',    'Awaiting Device Handoff','Nicholas Croft','Pending customer physical delivery to IT suite.', '2026-06-16 17:10:00'),
